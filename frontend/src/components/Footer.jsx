      ...
      <div className="footer-top-row">
        ...
        <div className="footer-col brand-col">
          <a href="/" className="footer-brand-logo" style={{ display: 'inline-block', marginBottom: '-50px' }}>
            <img src="https://media.zoniraz.com/uploads/zoniraz_frontend/zoni.png" alt="Zoniraz Logo" loading="lazy" decoding="async" width="150" height="150" style={{ height: '150px', objectFit: 'contain', display: 'block', marginLeft: '-22px' }} />
          </a>
          ...
          <ul className="footer-links-list contact-info-list" style={{ display: 'flex', flexDirection: 'column', gap: '12px', alignItems: 'inherit' }}>
            ...
            <li style={{ display: 'flex', gap: '10px', alignItems: 'center', listStyle: 'none' }}>
              ...
              <a
                ...
                onMouseEnter={e => { e.currentTarget.style.background = '#c5a880'; e.currentTarget.style.color = '#fff'; }}
      ...
      <div className="footer-bottom-row">
        ...
        <div className="footer-social-wrapper">
          ...
          <div className="social-icons-group">
            {/* YouTube */}
            <a href="https://www.youtube.com/@zonirazjewel" target="_blank" rel="noopener noreferrer" className="social-circle-btn" aria-label="Visit our YouTube channel" title="YouTube">
            ...
            {/* Pinterest */}
            <a href="https://pin.it/4wDWdW6Nr" target="_blank" rel="noopener noreferrer" className="social-circle-btn" aria-label="Visit our Pinterest page" title="Pinterest">
              <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
            ...
            {/* X */}
            <a href="https://x.com/zonirazjewel" target="_blank" rel="noopener noreferrer" className="social-circle-btn" aria-label="Visit our X profile" title="X">
              <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
              </svg>
            </a>
            {/* Facebook */}
            <a href="https://www.facebook.com/zonirazjewel/" target="_blank" rel="noopener noreferrer" className="social-circle-btn" aria-label="Visit our Facebook page" title="Facebook">
              <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
              </svg>
            </a>
            {/* Instagram */}
            <a href="https://www.instagram.com/zonirazjewel/" target="_blank" rel="noopener noreferrer" className="social-circle-btn" aria-label="Visit our Instagram profile" title="Instagram">
              <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
            ...
            {/* LinkedIn */}
            <a href="https://www.linkedin.com/company/zonirazjewel/" target="_blank" rel="noopener noreferrer" className="social-circle-btn" aria-label="Visit our LinkedIn page" title="LinkedIn">
              <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/>
              </svg>
            </a>
            {/* Threads */}
            <a href="https://www.threads.com/@zonirazjewel/" target="_blank" rel="noopener noreferrer" className="social-circle-btn" aria-label="Visit our Threads profile" title="Threads">
              <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
