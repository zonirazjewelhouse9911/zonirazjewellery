...
const diamondRingImg = "https://media.zoniraz.com/uploads/zoniraz_frontend/infinity_diamond_ring.jpg";

const goldSavingImg = "https://media.zoniraz.com/uploads/zoniraz_frontend/solitaire-sets.jpg";
const pendantImg = "https://media.zoniraz.com/uploads/zoniraz_frontend/layered-necklaces.jpg";
...
const allBlogContent = [
  {
    ...
    date: "July 28, 2026",
    readTime: "5 min read",
    image: "https://images.unsplash.com/photo-1588444837495-c6cfeb53f32d?auto=format&fit=crop&q=80&w=1200",
    content: [
  ...
  },
  {
    ...
    date: "June 15, 2026",
    readTime: "5 min read",
    image: "https://images.unsplash.com/photo-1569397288884-4d43d6738fbd?auto=format&fit=crop&q=80&w=1200",
    content: [
    ...
    return (
      <div className="blog-detail-wrapper">
        <style>{`
          ...
          .blog-not-found p { color: #6e6359; margin-bottom: 24px; }
          .back-btn {
            background: #221c17;
            color: white;
            border: none;
  ...
  return (
    <div className="blog-detail-wrapper">
      ...
      <style>{`
        ...
        .blog-content-tip {
          background: linear-gradient(90deg, #fdf8f3, #fff9f4);
        ...
        .blog-cta-btn:hover { background: #d4b990; transform: translateY(-2px); }
        ...
        .blog-back-btn:hover { border-color: #9e7a56; color: #9e7a56; }

        @media (max-width: 768px) {
          .blog-detail-title { font-size: 26px; }
          .blog-detail-hero-img { height: 240px; }
          .blog-content-intro { padding: 20px; font-size: 15px; }
          .blog-detail-cta { padding: 28px 20px; }
        }
      `}</style>
      ...
      <div className="blog-detail-container">
        ...
        <div className="blog-detail-cta">
          <h3>Explore Our Jewellery Collections</h3>
          <p>Browse Zoniraz's curated range of BIS hallmarked gold and diamond jewellery — crafted for every occasion.</p>
          <button
